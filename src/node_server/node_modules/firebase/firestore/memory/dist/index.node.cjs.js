...
var V$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, U$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.L = function(t, e, r) {
...
/** A dot-separated path for navigating sub-objects within a document. */ U$1.H = new U$1([]);
...
var O$1 = /** @class */ function() {
     ...
     */
    t.it = function(e) {
        return new t(new L$1(e.slice()));
    }, t;
}();

O$1.EMPTY = new O$1(new L$1([]));
...
var C$1 = /** @class */ function() {
    ...
    t.prototype.lt = function() {
        return new P$1(this.root, null, this.k, !1);
    }, t.prototype._t = function(t) {
        return new P$1(this.root, t, this.k, !1);
    }, t.prototype.dt = function() {
        return new P$1(this.root, null, this.k, !0);
    }, t.prototype.ft = function(t) {
        return new P$1(this.root, t, this.k, !0);
    }, t;
}(), P$1 = /** @class */ function() {
    function t(t, e, n, r) {
        this.wt = r, this.Tt = [];
...
var q$1 = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Nt = function(t) {
        ...
        return new F$1(this.data.lt());
    }, t.prototype._t = function(t) {
        return new F$1(this.data._t(t));
    }, 
...
/** Extracts the backend's type order for the provided value. */ function J$1(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? H$1(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Le("Invalid value type: " + JSON.stringify(t));
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function Z$1(t, e) {
    var n = J$1(t);
    if (n !== J$1(e)) return !1;
    switch (n) {
      case 0 /* NullValue */ :
      ...
      case 9 /* ArrayValue */ :
        return Ce(t.arrayValue.values || [], e.arrayValue.values || [], Z$1);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (G$1(n) !== G$1(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !Z$1(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function tt(t) {
    return function t(e) {
        ...
        O$1.tt(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function rt(t) {
    return "string" == typeof t ? Q$1.fromBase64String(t) : Q$1.fromUint8Array(t);
}
...
var ft = /** @class */ function() {
    ...
    return t.prototype.qt = function(t, e) {
        ...
        return e instanceof t && Ce(this.elements, e.elements, Z$1);
    }, t;
}(), lt = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    t.prototype.xt = function(t) {
        ...
        return e instanceof t && Z$1(this.Qt, e.Qt);
...
var _t = /** @class */ function() {
    ...
    return __extends(n, e), n.prototype.field = function(t) {
        ...
        return null !== r && null !== i ? K$1(r, i) : Le("Trying to compare documents on fields that don't exist");
    }, n;
    ...
    return t.prototype.canonicalId = function() {
        if (null === this.Ae) {
            ...
            t += this.filters.map((function(t) {
                ...
                return t.canonicalId();
            })).join(","), B$1(this.limit) || (t += "|l:", t += this.limit), this.startAt && (t += "|lb:", 
        ...
        B$1(this.limit) || (t += ", limit: " + this.limit), this.orderBy.length > 0 && (t += ", orderBy: [" + this.orderBy.join(", ") + "]"), 
        ...
        return O$1.st(this.path) && null === this.collectionGroup && 0 === this.filters.length;
    }, t;
}(), Vt = /** @class */ function() {
    /**
    ...
    t.prototype.canonicalId = function() {
        ...
        return !B$1(this.limit) && "F" /* First */ === this.pe;
    }, t.prototype.Ge = function() {
        return !B$1(this.limit) && "L" /* Last */ === this.pe;
    ...
    t.prototype.Ue = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.et(this.collectionGroup) && this.path.B(e) : O$1.st(this.path) ? this.path.isEqual(e) : this.path.W(e);
    }, 
    /**
...
var Ot = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        ...
        if (ut(r)) {
            if (e !== Ut.EQUAL) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (at(r)) {
            if (e !== Ut.EQUAL) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && J$1(this.value) === J$1(e) && this.Ye(K$1(e, this.value));
        ...
        return t instanceof n && this.op.isEqual(t.op) && this.field.isEqual(t.field) && Z$1(this.value, t.value);
    }, n.prototype.toString = function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = O$1.tt(r.referenceValue), i;
    }
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = O$1.k(t.key, this.key);
        return this.Ye(e);
    }, n;
    ...
    function n(t, n) {
        ...
        return (r = e.call(this, t, Ut.IN, n) || this).keys = (n.arrayValue.values || []).map((function(t) {
            return O$1.tt(t.referenceValue);
        })), r;
    }
    return __extends(n, e), n.prototype.matches = function(t) {
    ...
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return st(e) && X$1(e.arrayValue, this.value);
    }, n;
    ...
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return null !== e && X$1(this.value.arrayValue, e);
    }, n;
    ...
    return __extends(n, e), n.prototype.matches = function(t) {
        ...
        return !(!st(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) {
            return X$1(e.value.arrayValue, t);
        }));
    }, n;
...
var xt, jt, Qt = /** @class */ function() {
    ...
    t.prototype.Je = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? O$1.k(O$1.tt(o.referenceValue), e.key) : K$1(o, e.field(i.field)), 
        ...
        for (var e = 0; e < this.position.length; e++) if (!Z$1(this.position[e], t.position[e])) return !1;
        return !0;
    }, t;
}(), Bt = /** @class */ function() {
    function t(t, e) {
...
}(), zt = new Bt(U$1.X(), Gt.ASCENDING), Ht = new Bt(U$1.X(), Gt.DESCENDING), Yt = /** @class */ function() {
    function t(
     ...
     */ , s) {
        void 0 === i && (i = R$1.MIN), void 0 === o && (o = R$1.MIN), void 0 === s && (s = Q$1.Ut), 
...
var te = new C$1(O$1.k);

function ee() {
    return te;
}

var ne = new C$1(O$1.k);

function re() {
    return ne;
}

var ie = new q$1(O$1.k);
 ...
 */ var ae = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.k = t ? function(e, n) {
            return t(e, n) || O$1.k(e.key, n.key);
        } : function(t, e) {
            return O$1.k(t.key, e.key);
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, le.Is(e, n)), new t(R$1.MIN, r, ue(), Kt(), oe());
    }, t;
}(), le = /** @class */ function() {
    function t(
    /**
    ...
    return t.Is = function(e, n) {
        return new t(Q$1.Ut, n, oe(), oe(), oe());
    }, t;
}(), pe = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = Q$1.Ut), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.ri = function(t) {
        ...
        return this.js = Kt(), this.Gs = ge(), this.zs = new q$1(Oe), i;
    }, 
    /**
    ...
    t.prototype.qs = function(t) {
        ...
        var e = this.Gs.get(t);
        return e || (e = new q$1(Oe), this.Gs = this.Gs.nt(t, e)), e;
    }, 
    /**
 ...
 */ var Ee = function() {
    ...
    t.prototype._i = function(t) {
        return this.options.di || B$1(t) ? t : {
            value: t
        };
    }, 
    /**
    ...
    t.prototype.fi = function(t) {
        var e;
        return B$1(e = "object" == typeof t ? t.value : t) ? null : e;
    }, 
    /**
    ...
    t.prototype.mi = function(t) {
        ...
        Q$1.fromBase64String(t || "")) : (Ve(void 0 === t || t instanceof Uint8Array, "value must be undefined or Uint8Array"), 
        Q$1.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.F(t.F());
    }, t.prototype.fromVersion = function(t) {
        return Ve(!!t, "Trying to deserialize version that isn't set"), R$1.v(this.v(t));
        ...
        // in the local target cache.
                return 4 === e.length ? L$1.H : this.Pi(e);
    }, Object.defineProperty(t.prototype, "gi", {
        get: function() {
            return new L$1([ "projects", this.ci.projectId, "databases", this.ci.database ]).G();
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.Ri = function(t) {
        return new L$1([ "projects", t.projectId, "databases", t.database ]);
    }, t.prototype.Pi = function(t) {
...
function(t, e, n, r, i) {
    ...
    function t() {
        ...
        this.gn = new q$1(je.me), 
        // A set of outstanding references to a document sorted by target id.
        this.yn = new q$1(je.bn)
     ...
     */
    t.prototype.Nn = function(t) {
        var e = this, n = O$1.EMPTY, r = new je(n, t), i = new je(n, t + 1), o = [];
        ...
        var e = O$1.EMPTY, n = new je(e, t), r = new je(e, t + 1), i = oe();
    ...
    return t.me = function(t, e) {
        return O$1.k(t.key, e.key) || Oe(t.On, e.On);
    }, 
    /** Compare by ID then by key */ t.bn = function(t, e) {
        return Oe(t.On, e.On) || O$1.k(t.key, e.key);
    }, t;
}(), Qe = /** @class */ function() {
    function t(t) {
        var e = this;
    ...
    t.prototype.rr = function(t, e, n) {
        ...
        return this.Yn(t, new O$1(e)).next((function(t) {
            var e = ee();
...
var bn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        En();
        try {
            return new t(Q$1.fromBase64String(e));
        } catch (e) {
        ...
        return new t(Q$1.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
...
/** A "context" object passed around while parsing user data. */ var Mn = /** @class */ function() {
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.zo = function(t, e, n) {
        var r = new Mn(2 /* MergeSet */ , t, U$1.H);
        xn("Data must be an object, but it was:", r, e);
        var i, o, s = this.Go(e, r);
        if (n) {
            for (var u = new q$1(U$1.k), a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
    ...
    /** Parse update data from an update() call. */ t.prototype.Ko = function(t, e) {
        var n = this, r = new Mn(1 /* Update */ , t, U$1.H);
        xn("Data must be an object, but it was:", r, e);
        var i = new q$1(U$1.k), o = Tt.le();
        x$1(e, (function(e, s) {
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Yo = function(t, e, n, r) {
        var i = new Mn(1 /* Update */ , t, U$1.H), o = [ jn(t, e) ], s = [ n ];
        ...
        for (var a = new q$1(U$1.k), h = Tt.le(), c = 0; c < o.length; ++c) {
    ...
    t.prototype.Xo = function(t, e, n) {
        void 0 === n && (n = !1);
        var r = new Mn(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t, U$1.H);
        return this.Jo(e, r);
    }, 
    ...
    t.prototype.ea = function(t, e) {
        ...
        return e.map((function(e, r) {
            ...
            var i = new Mn(3 /* Argument */ , t, U$1.H);
 ...
 */
function Gn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof S$1 || t instanceof Vn || t instanceof bn || t instanceof qn || t instanceof Tn);
}
 ...
 */ var zn = /** @class */ function() {
    ...
    t.prototype.Qu = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                ...
                this.gu.lastStreamToken = Q$1.Ut, this._u.Qh(Q$1.Ut).catch(Ke)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype.Oc = function() {
        ...
        try {
            ...
            return !B$1(e) && e.catch && e.then ? e : (this.gr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Hc = this.Hc.remove(i), this.Jc.delete(t), this.cl(), o = (o = new C$1(O$1.k)).nt(i, new Rt(i, R$1.S())), 
                    s = oe().add(i), u = new fe(R$1.MIN, 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new q$1(Oe), o, s), [ 2 /*return*/ , this.jh(u) ]) : [ 4 /*yield*/ , this._u.co(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.hl(t, r);
                    })).catch(Ke) ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.wl = function(t) {
        ...
        n || (n = new C$1(Oe)), n = n.nt(t, e), this.Xc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Pl = function() {
        ...
        this.Jc.forEach((function(e, n) {
            t.Lc.$u(n);
        })), this.Yc.kn(), this.Jc = new Map, this.Hc = new C$1(O$1.k);
    }, 
    /**
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.U(), n = t.O(), r = this.index[e] || new q$1(L$1.k), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.U(), n = t.O(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new q$1(L$1.k)).j();
    }, t;
}(), yr = /** @class */ function() {
    function t(t, e) {
        this.Jn = t, this.dh = e, 
        ...
        /** The last received stream token from the server, used to acknowledge which
             ...
             * markers whose only real value is their inclusion in the next request.
             */
        this.lastStreamToken = Q$1.Ut, 
        /** An ordered mapping between documents and the mutations batch IDs. */
        this.zl = new q$1(je.me);
    }
    return t.prototype.Kl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                O$1.st(i) || (i = i.child(""));
        var o = new je(new O$1(i), 0), s = new q$1(Oe);
    ...
    t.prototype.Yh = function(t) {
        ...
        for (var r = ee(), i = new O$1(e.path.child("")), o = this.docs._t(i)
    ...
    return t.prototype.initialize = function(t, r, i, o, s, u, a, h) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (h.B_) throw new A$1(b.FAILED_PRECONDITION, br);
        ...
        throw new A$1(b.FAILED_PRECONDITION, br);
    }, t;
}(), Nr = /** @class */ function() {
    function t(t, e, n, 
    /**
...
var _r = /** @class */ function() {
    ...
    return t.prototype.rd = function(t) {
        ...
        var n = new Me(e.get(1), e.get(3)), r = new O$1(e.$(5));
    ...
    function t(t) {
        ...
        un("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Ze.nh; else {
            if (t.cacheSizeBytes !== kr && t.cacheSizeBytes < Ze.ih) throw new A$1(b.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Ze.ih);
    ...
    return t.prototype.settings = function(t) {
        ...
        var e = new Sr(t);
        if (this.Td && !this.Ad.isEqual(e)) throw new A$1(b.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.Td) throw new A$1(b.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                if (void 0 !== this.Td && !this.Td.X_) throw new A$1(b.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        ...
        get: function() {
            if (!this.dd) throw new A$1(b.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.dd;
        },
        enumerable: !0,
        configurable: !0
        ...
        return this.wd(), new Pr(new Vt(L$1.H, t), this);
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.$d) throw new A$1(b.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Vr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        if (o.Y()) {
            if (s === Ut.ARRAY_CONTAINS || s === Ut.ARRAY_CONTAINS_ANY) throw new A$1(b.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + s.toString() + "' queries on FieldPath.documentId().");
            if (s === Ut.IN) {
                this.Wd(r, s);
        ...
        if (null !== this.Qd.startAt) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.Qd.endAt) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
    ...
    t.prototype.Jd = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.Qd.He() && -1 !== s.indexOf("/")) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.Qd.path.child(L$1.K(s));
                if (!O$1.st(u)) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new O$1(u);
    ...
    t.prototype.jd = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.Qd.He() && -1 !== t.indexOf("/")) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.Qd.path.child(L$1.K(t));
            if (!O$1.st(e)) throw new A$1(b.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return it(this.firestore._d, new O$1(e));
        }
        if (t instanceof Vr) {
            var n = t;
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.tf.ds) throw new A$1(b.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Vt.ve(t), n, r) || this).nf = t, t.length % 2 != 1) throw new A$1(b.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.G() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.q() ? null : new Vr(new O$1(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
...
var zr = gn(Rr, "Use firebase.firestore() instead."), Hr = gn(Dr, "Use firebase.firestore().runTransaction() instead."), Yr = gn(Lr, "Use firebase.firestore().batch() instead."), Wr = gn(Vr, "Use firebase.firestore().doc() instead."), Jr = gn(Or), Zr = gn(Cr), Xr = gn(Pr), Kr = gn(Mr), $r = gn(qr, "Use firebase.firestore().collection() instead."), ti = {
     ...
     */    return t.prototype.Pf = function(t, e) {
        ...
        var n = [ this.Af, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = tmp_1(), i = {
        ...
        return v(tmp_4.EventType.OPEN, (function() {
            ...
            d || (d = !0, Se("Connection", "WebChannel transport errored:", t), y.Rf(new A$1(b.UNAVAILABLE, "The operation could not be completed")));
